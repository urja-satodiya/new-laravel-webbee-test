...
class ExampleTest extends TestCase
{
    ...
    //         ->assertJsonPath('1.name', 'Laravel convention 2022')
    //         ->assertJsonPath('2.name', 'React convention 2022');
    // }
    ...
    public function testFutureEvents() {
        ...
        $response->assertStatus(200)
            ->assertJsonCount(2)
            ->assertJsonPath('0.name', 'Laravel convention 2022')
            ...
            ->assertJsonPath('1.name', 'React convention 2022')
